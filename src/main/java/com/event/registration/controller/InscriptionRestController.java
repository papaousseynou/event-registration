...
public class InscriptionRestController {
    ...
    @GetMapping
    public List<Inscription> getAllInscriptions(@RequestParam(required = false) Long evenementId) {
        return inscriptionService.getInscriptionsByEvenement(evenementId);
    }
}
